...
const messages = {
    en: {
        ...
        "success.ready": "Environment ready! Context in docs/context/, rules in .cursor/rules/.",
        "warn.noOutput": "Default Context Generator: process finished but docs/context/ and .cursor/rules/ were not created. Check the \"Default Context Generator\" panel and ensure Cursor CLI is installed and the prompt was applied.",
    ...
    pt: {
        ...
        "success.ready": "Ambiente pronto! Contexto em docs/context/, rules em .cursor/rules/.",
        "warn.noOutput": "Default Context Generator: processo finalizou, mas docs/context/ e .cursor/rules/ não foram criados. Veja o painel \"Default Context Generator\" e confira se o Cursor CLI está instalado e o prompt foi aplicado.",
        ...
        "popup.btnConfig": "Apontar ou criar arquivo de configurações",
        "popup.btnConfigChange": "Alterar arquivo de configurações",
        ...
        "language.pickTitle": "Idioma do repositório (para docs e rules gerados)",
        "language.english": "Inglês",
        "language.portuguese": "Português",
        "language.mixed": "Misto (códigos legados muito grandes)",
