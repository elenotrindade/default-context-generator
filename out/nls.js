...
const messages = {
    en: {
        ...
        "popup.btnOpenPrompt": "Open prompt config file",
        "error.openPromptConfig": "Could not open config file: {0}",
        ...
        "chat.pasted": "Default Context Generator: prompt pasted into chat. Send when ready.",
    ...
    pt: {
        ...
        "popup.btnOpenPrompt": "Abrir ficheiro de prompt",
        "error.openPromptConfig": "Não foi possível abrir o ficheiro de configuração: {0}",
        ...
        "chat.pasted": "Default Context Generator: prompt colado no chat. Envie quando quiser.",
